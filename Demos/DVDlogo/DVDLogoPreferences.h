...
FOUNDATION_EXPORT NSString * const DVDLogoPreferenceKeySpeed;
FOUNDATION_EXPORT NSString * const DVDLogoPreferenceKeySize;
FOUNDATION_EXPORT NSString * const DVDLogoPreferenceKeyColorMode;
FOUNDATION_EXPORT NSString * const DVDLogoPreferenceKeyColorRate;
FOUNDATION_EXPORT NSString * const DVDLogoPreferenceKeyPalette;
